...
![alt text](<Adobe Express - leetcode.gif>)
...
```
               ...
               Fetch Submission Details
                  ...
                  SQLite (status = 4)
                           │
                           ▼
 Generate problem README & Uploading to GitHUb
                           │
                           ▼
                  SQLite (status = 5)
                           │
                           ▼ 
            Getting Solutions and Uploding
                           │
                           ▼
                  SQLite (status = 6)
                           │
                           ▼ 
      Generate root README & Uploading to GitHUb
                           │
                           ▼
                  SQLite (status = 7)
                           │
